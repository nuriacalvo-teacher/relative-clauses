...
const exercisesData = [
    ...
    { type: 'multipleChoice', question: 'The day I met you was special.', options: ['what', 'where', 'why', 'which'], correct: [''] },
    ...
    { type: 'rephrasing', instruction: 'Combine: This is my phone. I bought it last week.', correct: ['This is my phone which I bought last week', 'This is my phone that I bought last week', 'This is my phone I bought last week', 'This is the phone I bought last week', 'This is the phone which I bought last week', 'This is the phone that I bought last week'] },
    { type: 'rephrasing', instruction: 'Rewrite: The teacher came late. He is always punctual.', correct: ['The teacher who is always punctual came late', 'The teacher, who is always punctual, came late'] },
    { type: 'rephrasing', instruction: 'Combine: I have a dog. Its name is Max.', correct: ['I have a dog whose name is Max'] },
    { type: 'rephrasing', instruction: 'Rewrite: We visited Paris. It is a beautiful city.', correct: ['We visited Paris, which is a beautiful city', 'We visited Paris which is a beautiful city'] },
    ...
    { type: 'rephrasing', instruction: 'Combine: She lives in London. London is the capital of England.', correct: ['She lives in London, which is the capital of England', 'She lives in London which is the capital of England'] },
    ...
    { type: 'rephrasing', instruction: 'Combine: The reason was important. I didn\'t understand it.', correct: ['The reason which I didn\'t understand was important', 'The reason, which I didn\'t understand, was important', 'The reason that I didn\'t understand was important', 'The reason I didn\'t understand was important'] },
    ...
    { type: 'rephrasing', instruction: 'Combine: The problem is complicated. It needs to be solved.', correct: ['The problem which needs to be solved is complicated', 'The problem that needs to be solved is complicated'] },
    ...
    { type: 'rephrasing', instruction: 'Rewrite: The music is nice. I\'m listening to it.', correct: ['The music which I\'m listening to is nice', 'The music that I\'m listening to is nice'] },
    { type: 'rephrasing', instruction: 'Combine: That\'s the moment. I realized the truth.', correct: ['That\'s the moment when I realized the truth'] },
